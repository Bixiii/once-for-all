...
__all__ = ['MyRunManager']


class MyRunManager:

    def __init__(self, path, net, run_config, init=False, measure_latency=None, no_gpu=False, comment=''):
        self.path = path
        self.net = net
        ...
        self.optimizer = torch.optim.SGD(
            ...
            momentum=self.run_config.momentum,
            weight_decay=self.run_config.weight_decay)

        # scheduler
        self.scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(self.optimizer, T_max=run_config.n_epochs)
